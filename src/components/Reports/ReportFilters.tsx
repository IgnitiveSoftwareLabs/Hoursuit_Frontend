...
const ReportFilters: React.FC<ReportFiltersProps> = ({
  ...
  const commodityOptions: FilterOption[] = [
    ...
    ...(commoditiesData?.result || []).map((commodity: any) => ({
      value: commodity.commodity_id.toString(),
      label: commodity.name || `Commodity ${commodity.commodity_id}`,
    })),
  ];
      ...
      <Card sx={{ mb: 3 }}>
        <CardContent>
          ...
          >
              ...
              <Box sx={{ flex: "1 1 200px", minWidth: 200 }}>
                <FormControl fullWidth size="small">
                  ...
                  <Select
                    ...
                    label="Commodity"
                    onChange={(e) =>
                      handleFilterChange("commodityId", e.target.value)
                    }
            ...
            {/* Custom Filters */}
            {customFilters && <Box sx={{ width: "100%" }}>{customFilters}</Box>}
          </Box>
