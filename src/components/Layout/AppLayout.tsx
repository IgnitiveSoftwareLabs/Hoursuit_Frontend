...
export default function AppLayout({ children }: { children: React.ReactNode }) {
        ...
        { label: "Transactions Overview", path: "/dashboard" },
        {
          ...
          children: [
            ...
            { label: "Purchase Payments", path: "/purchase-payment", permission: { module: "purchase_payment", action: "read" } },
            {
              ...
              subChildren: [
                { label: "Return Authorizations", path: "/purchase-return", permission: { module: "purchase_return", action: "read" } },
                { label: "Item Return Fulfillments", path: "/return-fulfillment", permission: { module: "purchase_return", action: "read" } },
                { label: "Vendor Credits", path: "/debit-note", permission: { module: "purchase_return", action: "read" } },
              ],
            },
            { label: "Item Return Fulfillments", path: "/return-fulfillment", permission: { module: "purchase_return", action: "read" } },
            { label: "Debit Notes (Vendor Credits)", path: "/debit-note", permission: { module: "purchase_return", action: "read" } },
          ],
        },
        {
          label: "Sales & Billing",
  ...
  function getBreadcrumbTitle(path: string): string {
    const routeMap: Record<string, string> = {
      ...
      "/debit-note": "Debit Notes (Vendor Credits)",
